...
import com.srm.system.audit.OpLogInterceptor;
import com.srm.system.auth.AuthInterceptor;
...
public class WebConfig implements WebMvcConfigurer {
    ...
    /** 允许跨域的前端来源，逗号分隔（srm.cors.origins / SRM_CORS_ORIGINS）；同源部署可留空 */
    @Value("${srm.cors.origins:http://localhost:5174}")
