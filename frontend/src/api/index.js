...
export const sourcing = {
  ...
  catalogMatch: (data) => http.post('/sourcing/catalog/match', data),
  shelf: (params) => http.get('/sourcing/shelf', { params }),
  shelfMarks: () => http.get('/sourcing/shelf/marks'),
  shelfFavorite: (data) => http.post('/sourcing/shelf/favorite', data),
  shelfUnfavorite: (materialCode) => http.delete('/sourcing/shelf/favorite', { params: { materialCode } }),
  shelfHistory: (data) => http.post('/sourcing/shelf/history', data),
  shelfCoupons: () => http.get('/sourcing/shelf/coupon'),
  shelfSaveCoupon: (data) => http.post('/sourcing/shelf/coupon', data),
  shelfUseCoupon: (data) => http.post('/sourcing/shelf/coupon/use', data),
  shelfPool: (params) => http.get('/sourcing/shelf/pool', { params }),
  shelfAddPool: (data) => http.post('/sourcing/shelf/pool', data),
  shelfRemovePool: (plantCode, materialCode) => http.delete('/sourcing/shelf/pool', { params: { plantCode, materialCode } }),
  demandList: () => http.get('/sourcing/demand'),
  demandAdd: (data) => http.post('/sourcing/demand', data),
  demandConvert: () => http.post('/sourcing/demand/convert'),
